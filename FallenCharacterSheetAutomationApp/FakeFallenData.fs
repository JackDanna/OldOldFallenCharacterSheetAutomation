...
module Data =
    ...
    let weaponClassData = [|
        ...
        ("Light Ranged (Melee)",              "None",          "-1", "CalculatedPenetration 0", "Melee",    "Bludgeon",      "EOCalculation Rapid",                  "None", "None", "None","{STR,RFX,INT}")
        ("Blowgun",                           "+0d6",   "+1d6",  "CalculatedPenetration 0", "Medium",   "",              "EOCalculation Standard",               "None", "None", "BlowgunDart","{STR,RFX,INT}")
        ("Unarmed",                           "-1",  "-1", "CalculatedPenetration 0", "Melee",    "Bludgeon",      "EOCalculation Rapid",                  "None", "None", "None","{STR,RFX,INT}")
        ...
        ("Large Hafted Blunt",                "-0",  "+1d6",  "CalculatedPenetration 5", "Melee",    "Bludgeon",      "EOCalculation Rapid",                  "None", "None", "None","{STR,RFX,INT}")
