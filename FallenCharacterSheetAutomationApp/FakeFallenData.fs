...
module Data =
    ...
    let magicCombatData = [|
        ("Melee Trick",   -1, "+0d6", "WeakCalc",   "Melee", "EOCalculation Rapid",    0u, false, "None")
        ("Melee",          0, "+0d6", "MediumCalc", "Reach", "EOCalculation Rapid",    1u, true,  "None")
        ("Ranged Trick",  -1, "+0d6", "WeakCalc",   "Close", "EOCalculation Standard", 0u, false, "None")
        ("Ranged",         0, "+0d6", "MediumCalc", "Close", "EOCalculation Standard", 1u, true,  "None")
        ("Cone",           0, "+0d6", "MediumCalc", "Close", "EOCalculation Standard", 1u, true,  "Cone")
        ("Focused",        1, "+1d6", "StrongCalc", "Close", "CalculatedEO Focused",   1u, true,  "None")
        ("Sphere",         1, "+0d6", "MediumCalc", "Close", "EOCalculation Standard", 2u, true,  "Sphere")
    |]

    let weaponClassData = [|
        ("Hand Crossbow",                     "+1d6",   "+1d6",  "0", "Medium",   "",              "EOCalculation Standard",               "None", "None", "Bolt","{STR,RFX,INT}")
        ("Light Crossbow",                    "None",          "+1d6",  "0", "Extended", "",              "EOCalculation Loading",                "None", "None", "Bolt","{STR,RFX,INT}")
        ("Heavy Crossbow",                    "None",          "+2d6",  "0", "Long",     "",              "EOCalculation Complex Loading",        "None", "None", "Bolt","{STR,RFX,INT}")
        ("Light Ranged (Melee)",              "None",          "-1", "0", "Melee",    "Bludgeon",      "EOCalculation Rapid",                  "None", "None", "None","{STR,RFX,INT}")
        ("Blowgun",                           "+0d6",   "+1d6",  "0", "Medium",   "",              "EOCalculation Standard",               "None", "None", "BlowgunDart","{STR,RFX,INT}")
        ("Unarmed",                           "-1",  "-1", "0", "Melee",    "Bludgeon",      "EOCalculation Rapid",                  "None", "None", "None","{STR,RFX,INT}")
        ("Hand Protection Unarmed",           "+0d6",   "+0d6",  "0", "Melee",    "Bludgeon",      "EOCalculation Rapid",                  "None", "None", "None","{STR,RFX,INT}")
        ("Disarming Unarmed",                 "+3d6",   "+3d6",  "0", "Melee",    "Bludgeon",      "EOCalculation Rapid",                  "None", "None", "None","{STR,RFX,INT}")
        ("Disarming Hand Protection Unarmed", "+4d6",   "+4d6",  "0", "Melee",    "Bludgeon",      "EOCalculation Rapid",                  "None", "None", "None","{STR,RFX,INT}")
        ("Small Hafted Axe",                  "+1d6",   "+1d6",  "0", "Melee",    "Hew",           "EOCalculation Rapid",           "+1d6", "None", "None","{STR,RFX,INT}")
        ("Small Hafted Blade",                "+1d6",   "+1d6",  "0", "Melee",    "Slash",         "EOCalculation Rapid",           "+1d6", "None", "None","{STR,RFX,INT}")
        ("Small Hafted Point",                "+1d6",   "+1d6",  "0", "Melee",    "Pierce",        "EOCalculation Rapid",           "+1d6", "None", "None","{STR,RFX,INT}")
        ("Small Blunt",                       "+0d6",   "+0d6",  "2", "Melee",    "Bludgeon",      "EOCalculation Rapid",           "+1d6", "None", "None","{STR,RFX,INT}")
        ("Small Bladed",                      "+0d6",   "+0d6",  "2", "Melee",    "Slash, Pierce", "EOCalculation Rapid",           "+1d6", "None", "None","{STR,RFX,INT}")
        ("Thrown Small Bladed",               "+0d6",   "+0d6",  "1", "Short",    "Pierce",        "EOCalculation Rapid",                  "None", "None", "None","{STR,RFX,INT}")
        ("Medium Hafted Blade",               "+2d6",   "+3d6",  "0", "Melee",    "Hew",           "EOCalculation Rapid",           "+1d6", "None", "None","{STR,RFX,INT}")
        ("Medium Hafted Point",               "+2d6",   "+3d6",  "0", "Melee",    "Pierce",        "EOCalculation Rapid",           "+1d6", "None", "None","{STR,RFX,INT}")
        ("Medium Hafted Blunt",               "+0d6",   "+1d6",  "4", "Melee",    "Bludgeon",      "EOCalculation Rapid",           "+1d6", "None", "None","{STR,RFX,INT}")
        ("Medium Sword",                      "+1d6",   "+2d6",  "2", "Melee",    "Slash, Pierce", "EOCalculation Rapid",           "+1d6", "None", "None","{STR,RFX,INT}")
        ("Large Hafted Blade",                "+0d6",   "+3d6",  "2", "Melee",    "Hew",           "EOCalculation Rapid",                  "None", "None", "None","{STR,RFX,INT}")
        ("Large Hafted Point",                "+0d6",   "+3d6",  "2", "Melee",    "Pierce",        "EOCalculation Rapid",                  "None", "None", "None","{STR,RFX,INT}")
        ("Large Hafted Blunt",                "-0",  "+1d6",  "5", "Melee",    "Bludgeon",      "EOCalculation Rapid",                  "None", "None", "None","{STR,RFX,INT}")
        ("Large Sword",                       "+2d6",   "+2d6",  "3", "Melee",    "Slash, Pierce", "EOCalculation Rapid",                  "None", "None", "None","{STR,RFX,INT}")
        ("Short Spear",                       "+1d6",   "+3d6",  "3", "Melee",    "Pierce",        "EOCalculation SpearRapid",      "+1d6", "None", "None","{STR,RFX,INT}")
        ("Reach Hafted Axe",                  "Remove 1",      "+4d6",  "3", "Reach",    "Hew",           "EOCalculation Rapid",                  "None", "None", "None","{STR,RFX,INT}")
        ("Reach Hafted Blade",                "Remove 1",      "+4d6",  "3", "Reach",    "Slash",         "EOCalculation Rapid",                  "None", "None", "None","{STR,RFX,INT}")
        ("Reach Hafted Point",                "Remove 1",      "+4d6",  "3", "Reach",    "Pierce",        "EOCalculation Rapid",                  "None", "None", "None","{STR,RFX,INT}")
        ("Reach Hafted Blunt",                "Remove 1",      "+2d6",  "3", "Reach",    "Bludgeon",      "EOCalculation Rapid",                  "None", "None", "None","{STR,RFX,INT}")
        ("Greatsword",                        "Remove 1",      "+3d6",  "4", "Reach",    "Slash, Pierce", "EOCalculation Rapid",                  "None", "None", "None","{STR,RFX,INT}")
        ("Longspear",                         "Remove 1",      "+4d6",  "4", "Reach",    "Pierce",        "EOCalculation SpearRapid",             "None", "None", "None","{STR,RFX,INT}")
        ("Whip",                              "+0d6",   "+0d6",  "0", "Reach",    "Slash",         "EOCalculation Rapid",           "+1d6", "None", "None","{STR,RFX,INT}")
        ("Man Catcher",                       "Remove 3",      "+1d6",  "2", "Reach",    "Bludgeon",      "EOCalculation Rapid",                  "None", "None", "None","{STR,RFX,INT}")
        //("", "", "", "", "", "", "", "None", "None", "None")
    |]
